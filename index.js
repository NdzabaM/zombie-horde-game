...
async function initGame() {
  ...
  try {
    ...
    let gamePreIntroScene = createScene("ZombieHorde", "Click to Continue");
    let gameStartScene = createScene("ZombieHorde", "Click to Start");
    let gameOverScene = createScene("ZombieHorde", "You are Dead");
